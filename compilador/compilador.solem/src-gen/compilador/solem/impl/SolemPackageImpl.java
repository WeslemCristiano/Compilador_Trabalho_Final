...
import compilador.solem.SolemFactory;
 ...
 * @generated
 */
public class SolemPackageImpl extends EPackageImpl implements SolemPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see compilador.solem.SolemPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private SolemPackageImpl()
  {
    super(eNS_URI, SolemFactory.eINSTANCE);
  }
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *
   * <p>This method is used to initialize {@link SolemPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static SolemPackage init()
  {
    if (isInited) return (SolemPackage)EPackage.Registry.INSTANCE.getEPackage(SolemPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredSolemPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    SolemPackageImpl theSolemPackage = registeredSolemPackage instanceof SolemPackageImpl ? (SolemPackageImpl)registeredSolemPackage : new SolemPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theSolemPackage.createPackageContents();

    // Initialize created meta-data
    theSolemPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theSolemPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(SolemPackage.eNS_URI, theSolemPackage);
    return theSolemPackage;
  }
   ...
   */
  @Override
  public SolemFactory getSolemFactory()
  {
    return (SolemFactory)getEFactoryInstance();
  }
