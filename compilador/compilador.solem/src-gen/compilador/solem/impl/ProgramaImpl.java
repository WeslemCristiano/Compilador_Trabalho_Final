 ...
 * </p>
 * <ul>
 *   <li>{@link compilador.solem.impl.ProgramaImpl#getDeclaracoes <em>Declaracoes</em>}</li>
 *   <li>{@link compilador.solem.impl.ProgramaImpl#getComandos <em>Comandos</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramaImpl extends MinimalEObjectImpl.Container implements Programa
{
  ...
  {
    return SolemPackage.Literals.PROGRAMA;
  }
  ...
  public EList<Declaracao> getDeclaracoes()
  {
    if (declaracoes == null)
    {
      declaracoes = new EObjectContainmentEList<Declaracao>(Declaracao.class, this, SolemPackage.PROGRAMA__DECLARACOES);
    }
    return declaracoes;
  }
  ...
  public EList<Comando> getComandos()
  {
    if (comandos == null)
    {
      comandos = new EObjectContainmentEList<Comando>(Comando.class, this, SolemPackage.PROGRAMA__COMANDOS);
    }
    return comandos;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SolemPackage.PROGRAMA__DECLARACOES:
        return ((InternalEList<?>)getDeclaracoes()).basicRemove(otherEnd, msgs);
      case SolemPackage.PROGRAMA__COMANDOS:
