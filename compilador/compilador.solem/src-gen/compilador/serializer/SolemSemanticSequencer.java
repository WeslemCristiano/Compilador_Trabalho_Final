...
import compilador.solem.ComandoCondicao;
import compilador.solem.ComandoEntrada;
import compilador.solem.ComandoRepeticao;
...
public class SolemSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SolemPackage.eINSTANCE)
	...
	protected void sequence_ComandoAtribuicao(ISerializationContext context, ComandoAtribuicao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.COMANDO_ATRIBUICAO__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.COMANDO_ATRIBUICAO__EXP));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.COMANDO_ATRIBUICAO__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.COMANDO_ATRIBUICAO__VARIAVEL));
		}
		...
		feeder.accept(grammarAccess.getComandoAtribuicaoAccess().getVariavelDeclaracaoIDTerminalRuleCall_3_0_1(), semanticObject.eGet(SolemPackage.Literals.COMANDO_ATRIBUICAO__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_ComandoEntrada(ISerializationContext context, ComandoEntrada semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.COMANDO_ENTRADA__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.COMANDO_ENTRADA__VARIAVEL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getComandoEntradaAccess().getVariavelDeclaracaoIDTerminalRuleCall_1_0_1(), semanticObject.eGet(SolemPackage.Literals.COMANDO_ENTRADA__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_ComandoRepeticao(ISerializationContext context, ComandoRepeticao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.COMANDO_REPETICAO__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.COMANDO_REPETICAO__EXP));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.COMANDO_REPETICAO__CMD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.COMANDO_REPETICAO__CMD));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ComandoSaida(ISerializationContext context, ComandoSaida semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.COMANDO_SAIDA__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.COMANDO_SAIDA__VARIAVEL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getComandoSaidaAccess().getVariavelDeclaracaoIDTerminalRuleCall_1_0_1(), semanticObject.eGet(SolemPackage.Literals.COMANDO_SAIDA__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_Declaracao(ISerializationContext context, Declaracao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.DECLARACAO__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.DECLARACAO__NAME));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.DECLARACAO__TIPO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.DECLARACAO__TIPO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_FatorNumero(ISerializationContext context, FatorNumero semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.FATOR_NUMERO__NUMERO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.FATOR_NUMERO__NUMERO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_FatorSubExpressao(ISerializationContext context, FatorSubExpressao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.FATOR_SUB_EXPRESSAO__EXPRESSAO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.FATOR_SUB_EXPRESSAO__EXPRESSAO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_FatorVariavel(ISerializationContext context, FatorVariavel semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.FATOR_VARIAVEL__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.FATOR_VARIAVEL__VARIAVEL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFatorVariavelAccess().getVariavelDeclaracaoIDTerminalRuleCall_0_1(), semanticObject.eGet(SolemPackage.Literals.FATOR_VARIAVEL__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_OutroFatorAritmetico(ISerializationContext context, OutroFatorAritmetico semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.OUTRO_FATOR_ARITMETICO__OPERADOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.OUTRO_FATOR_ARITMETICO__OPERADOR));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.OUTRO_FATOR_ARITMETICO__FATOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.OUTRO_FATOR_ARITMETICO__FATOR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_OutroTermoAritmetico(ISerializationContext context, OutroTermoAritmetico semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.OUTRO_TERMO_ARITMETICO__OPERADOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.OUTRO_TERMO_ARITMETICO__OPERADOR));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.OUTRO_TERMO_ARITMETICO__TERMO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.OUTRO_TERMO_ARITMETICO__TERMO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_OutroTermoRelacional(ISerializationContext context, OutroTermoRelacional semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.OUTRO_TERMO_RELACIONAL__OPERADOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.OUTRO_TERMO_RELACIONAL__OPERADOR));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.OUTRO_TERMO_RELACIONAL__TERMO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.OUTRO_TERMO_RELACIONAL__TERMO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_TermoComparacaoRelacional(ISerializationContext context, TermoComparacaoRelacional semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.TERMO_COMPARACAO_RELACIONAL__EXP1) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.TERMO_COMPARACAO_RELACIONAL__EXP1));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.TERMO_COMPARACAO_RELACIONAL__OP_REL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.TERMO_COMPARACAO_RELACIONAL__OP_REL));
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.TERMO_COMPARACAO_RELACIONAL__EXP2) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.TERMO_COMPARACAO_RELACIONAL__EXP2));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_TermoSubExpressaoRelacional(ISerializationContext context, TermoSubExpressaoRelacional semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SolemPackage.Literals.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SolemPackage.Literals.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
