...
import compilador.ide.contentassist.antlr.internal.InternalSolemParser;
import compilador.services.SolemGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class SolemParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(SolemGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SolemGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalSolemParser createParser() {
		InternalSolemParser result = new InternalSolemParser(null);
